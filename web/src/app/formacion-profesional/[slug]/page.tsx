      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl">
            ...
            {/* Video embeds */}
            {"videos" in programa && (programa as any).videos && (
              <VideoEmbed videos={(programa as any).videos} title="Video del programa" />
            )}
            ...
            <ScrollReveal>
              <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm sm:p-10">
                ...
                {"especialistas" in programa && (programa as any).especialistas && (
                  <div className="mt-8 space-y-4">
                    <h3 className="text-lg font-semibold text-[#1b4332]">Especialistas</h3>
                    {(programa as any).especialistas.map((esp: any) => (
                      <div
                        key={esp.name}
