...
const galleryImages: Record<string, string[]> = {
  "grabado-no-toxico": ["grabado/destacada.jpg", "grabado/obra.jpg"],
  "encuentro-aynilab-juegos": ["encuentro/encuentro.jpg", "encuentro/slide.jpg"],
  "taller-cerveza-artesanal": ["cerveza/destacada.jpg", "cerveza/yatasto.jpg"],
  "taller-escultura-chocolate": ["chocolate/escultura.jpg"],
};
