...
const servicios = aynincubaContent.servicios.map((s) => ({
  ...s,
  icon: (() => {
    switch (s.title) {
      case "Networking":
        ...
        <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            <div className="flex flex-col items-center text-center">
              <Image
                src="/images/aynincuba/logo.webp"
                alt="AynIncuba"
                width={120}
                height={96}
        ...
        <ScrollReveal>
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-lg leading-relaxed text-gray-700">
              {aynincubaContent.accreditation}
            </p>
          </div>
        </ScrollReveal>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:px-8">
        <ScrollReveal>
          <div className="mx-auto max-w-3xl">
            ...
            <p className="mt-6 text-lg leading-relaxed text-gray-700">
              {aynincubaContent.description}
            </p>
            <p className="mt-4 leading-relaxed text-gray-600">
              {aynincubaContent.networking}
            </p>
            <div className="mt-8 rounded-2xl border border-gray-200 bg-[#f5f5f5] p-8">
              ...
              <ul className="mt-4 space-y-4">
                {aynincubaContent.programas.map((programa) => (
                  <li key={programa.slug} className="flex items-start gap-3">
                    <span className="mt-1 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[#2d6a4f] text-xs text-white">
                      ✓
                    </span>
                    <div>
                      <Link
                        href={`/aynincuba/${programa.slug}`}
                        className="font-semibold text-gray-900 transition-colors hover:text-[#2d6a4f]"
                      >
                        {programa.title}
                      </Link>
        ...
        <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h2 className="mt-3 text-3xl font-bold text-gray-900">
                Niveles de{" "}
                <span className="text-gradient">Incubación</span>
              </h2>
              <p className="mt-4 text-gray-600">
                Dos niveles de acompañamiento según la etapa de tu proyecto
              </p>
            </div>
          </ScrollReveal>
          <div className="mt-10 grid gap-8 md:grid-cols-2">
            {aynincubaContent.niveles.map((nivel, idx) => (
              <ScrollReveal key={nivel.nombre} delay={idx * 100}>
                <div className="group h-full rounded-2xl border border-gray-200 bg-white p-8 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:border-[#d8f3dc]">
                  <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-[#d8f3dc] text-[#2d6a4f] transition-all duration-300 group-hover:bg-[#2d6a4f] group-hover:text-white">
                    <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  ...
                  <h3 className="text-xl font-bold text-gray-900 group-hover:text-[#2d6a4f] transition-colors">
                    {nivel.nombre}
                  </h3>
      ...
      <section className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:px-8">
        <ScrollReveal>
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-gray-600">
              Formación especializada para emprendedores creativos
            </p>
          </div>
        </ScrollReveal>
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          {aynincubaContent.cursos.map((curso, idx) => (
            <ScrollReveal key={curso.titulo} delay={idx * 100}>
              <div className="group rounded-2xl border border-gray-200 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:border-[#d8f3dc]">
                <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-lg bg-[#d8f3dc] text-[#2d6a4f]">
                  <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M4.26 10.147a60.438 60.438 0 0 0-.491 6.347A48.62 48.62 0 0 1 12 20.904a48.62 48.62 0 0 1 8.232-4.41 60.46 60.46 0 0 0-.491-6.347m-15.482 0a50.636 50.636 0 0 0-2.658-.813A59.906 59.906 0 0 1 12 3.493a59.903 59.903 0 0 1 10.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.717 50.717 0 0 1 12 13.489a50.702 50.702 0 0 1 7.74-3.342M6.75 15a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Zm0 0v-3.675A55.378 55.378 0 0 1 12 8.443m-7.007 11.55A5.981 5.981 0 0 0 6.75 15.75v-1.5" />
                  </svg>
                </div>
                <h3 className="font-bold text-gray-900 group-hover:text-[#2d6a4f] transition-colors">
                  {curso.titulo}
                </h3>
                <p className="mt-1 text-xs font-medium text-[#52b788]">
                  por {curso.docente}
                </p>
                <p className="mt-2 text-sm leading-relaxed text-gray-500">
                  {curso.descripcion}
