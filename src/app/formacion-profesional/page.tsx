        ...
        <div className="space-y-12">
          {formacionProfesionalContent.programas.map((programa, idx) => (
            <ScrollReveal key={idx} delay={idx * 100}>
              <div className="group rounded-2xl border border-gray-200 bg-white p-8 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg sm:p-10">
                ...
                <p className="mt-2 leading-relaxed text-gray-500">{programa.details}</p>
